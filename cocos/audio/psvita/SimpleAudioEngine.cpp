...
struct SimpleAudioEnginePsVita{
...
SimpleAudioEnginePsVita * g_SimpleAudioEnginePsVita = nullptr; 


SimpleAudioEngine* SimpleAudioEngine::getInstance(){
  if(!g_SimpleAudioEnginePsVita){
    g_SimpleAudioEnginePsVita = new SimpleAudioEnginePsVita();
    g_SimpleAudioEnginePsVita->engine = new SimpleAudioEngine(); 
  }
  return g_SimpleAudioEnginePsVita->engine; 
};

  void SimpleAudioEngine::end(){
    if(g_SimpleAudioEnginePsVita){
      delete g_SimpleAudioEnginePsVita->engine; 
      delete g_SimpleAudioEnginePsVita;       
    }
    g_SimpleAudioEnginePsVita = nullptr; 
  };
  
  
    SimpleAudioEngine::SimpleAudioEngine(){
      g_SimpleAudioEnginePsVita->musicid = -1;
      g_SimpleAudioEnginePsVita->effectsvolume = 1.0f; 
    };
    ...
    void SimpleAudioEngine::preloadBackgroundMusic(const char* filePath){
      g_SimpleAudioEnginePsVita->musicpath = filePath; 
      AudioEngine::preload(filePath); 
    };
    
    void SimpleAudioEngine::playBackgroundMusic(const char* filePath, bool loop){
      g_SimpleAudioEnginePsVita->musicpath = filePath; 
      g_SimpleAudioEnginePsVita->musicid = AudioEngine::play2d(filePath, loop); 
    };

    void SimpleAudioEngine::stopBackgroundMusic(bool releaseData){
      AudioEngine::stop(g_SimpleAudioEnginePsVita->musicid);
      if(releaseData){
        AudioEngine::uncache(g_SimpleAudioEnginePsVita->musicpath.c_str()); 
      }
    };

    void SimpleAudioEngine::pauseBackgroundMusic(){
      AudioEngine::pause(g_SimpleAudioEnginePsVita->musicid); 
    };

    void SimpleAudioEngine::resumeBackgroundMusic(){
      AudioEngine::resume(g_SimpleAudioEnginePsVita->musicid);
    };

    void SimpleAudioEngine::rewindBackgroundMusic(){
      AudioEngine::setCurrentTime(g_SimpleAudioEnginePsVita->musicid, 0);
    };

    bool SimpleAudioEngine::willPlayBackgroundMusic(){
      return g_SimpleAudioEnginePsVita->musicid != -1; 
    };

    bool SimpleAudioEngine::isBackgroundMusicPlaying(){
        return AudioEngine::getState(g_SimpleAudioEnginePsVita->musicid) == AudioEngine::AudioState::PLAYING; 
    };
    ...
    float SimpleAudioEngine::getBackgroundMusicVolume(){
      return AudioEngine::getVolume(g_SimpleAudioEnginePsVita->musicid);
    };
    ...
    void SimpleAudioEngine::setBackgroundMusicVolume(float volume){
      AudioEngine::setVolume(g_SimpleAudioEnginePsVita->musicid, volume); 
    };
    ...
    float SimpleAudioEngine::getEffectsVolume(){
      return g_SimpleAudioEnginePsVita->effectsvolume;
    };
    ...
    void SimpleAudioEngine::setEffectsVolume(float volume){
      g_SimpleAudioEnginePsVita->effectsvolume = volume; 
    };
